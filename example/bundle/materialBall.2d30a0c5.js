...
`});var m=h("ilwiq"),u=h("RPVlj"),g=h("7lx9d"),f=h("5Rd1x"),m=h("ilwiq"),v=h("9fZ6X");class x extends v.MaterialBase{constructor(e){super({blending:m.NoBlending,transparent:!1,depthWrite:!1,depthTest:!1,defines:{USE_SLIDER:0},uniforms:{sigma:{value:5},threshold:{value:.03},kSigma:{value:1},map:{value:null},opacity:{value:1}},vertexShader:`
